<template>
  <div class="container-fluid background py-5" id="treatments">
    <div class="container">
      <p class="results-title text-center mb-5">Nossos Tratamentos</p>
...
.custom-icon {
  filter: none !important; /* Remove o preto do carousel-dark */
